"""
Modified from
https://github.com/UKPLab/sentence-transformers/blob/master/sentence_transformers/evaluation/MSEEvaluator.py
"""
...
class MSEEval(SentenceEvaluator):
    ...
    def __init__(self, source_embeddings: torch.Tensor, target_sentences: List[str], teacher_model=None,
        ...
        self.source_embeddings = source_embeddings.detach().numpy()
